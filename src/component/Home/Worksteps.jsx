...
function Worksteps() {
  return (
    <div>
      ...
      <div className="bg-gray-300 text-white py-5 px-5">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="text-center md:w-1/3 px-4 bg-gray-400   p-5 rounded-md">
              <FaUserPlus className="text-pink-600 text-6xl mb-4 mx-auto" />
            ...
            <div className="text-center md:w-1/3 px-4 bg-gray-400   p-5 rounded-md">
              <FaSearch className="text-pink-600 text-6xl mb-4 mx-auto" />
            ...
            <div className="text-center md:w-1/3 px-4 bg-gray-400   p-5 rounded-md">
              <FaDonate className="text-pink-600 text-6xl mb-4 mx-auto" />
